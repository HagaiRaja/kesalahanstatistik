...
Angkanya tinggi bukan? Masalahnya, terdapat dua hal aneh disana. Pertama, secara hebat, nilai tersebut didapatkan secara akurat. Yang kedua, kemungkinan nilai tersebut terlihat sangat “menyenangkan”. Namun, apabila kita analisis dengan teliti, terdapat beberapa keanehan didalam data tersebut.

Pertama, apakah kita yakin bahwa anggota Universitas X benar-benar memiliki angka seakurat itu? Biasanya, orang hanya mengingat range gaji mereka, dengan pembulatan. Bagaimana bisa perhitungan dilakukan sampai terlihat seakan-akan angkanya menjadi seakurat itu? Tidak banyak orang yang bisa menghafalkan nilai gaji mereka sampai ke tiga digit terakhir.
...
Kelihatannya valid. Tidak ada kesalahan yang terulang dari poin pertama, yaitu sampel yang tidak jelas. Angka hasil akhirnya juga berupa angka yang bulat, yang tidak mencurigakan karena tidak begitu “detail”. Mengenai pengambilan data? Yah, perusahaan pasti memiliki nilai yang detail tentang gaji setiap pegawainya. Tetapi, data perusahaan ini tetap dapat menipu kita. Bagaimana data itu menipu kita?

Terdapat tiga jenis “rata-rata” yang bisa diambil dengan menggunakan data yang ada. Yang pertama bernama Mean (rata-rata biasa), Modus (diambil data terbanyak yang muncul), dan Median (Nilai tengah). Biasanya, ketiga nilai ini tidak berbeda jauh, namun apabila terdapat perbedaan yang jauh,hal ini dapat menyebabkan jenis kesalahan statistik yang lain.
...
Mari kita analisis fakta ini. Terdapat beberapa hal yang salah dari statistik ini. Yang pertama, yang bisa terlihat jelas, adalah angka yang terlalu mendetail dan tepat untuk sebuah nilai statistik. Tapi tunggu, apabila kita kembali ke poin 1 diatas, dikatakan bahwa seharusnya sebuah statistik tidak harus terlalu detail? Akan dijelaskan lebih lanjut apa yang dimaksud dengan detail.

Anggap mereka melakukan pengambilan data dengan tepat dan jujur. Anggap pula hanya suara dokter gigi yang menjawab pengambilan data yang mereka lakukan adalah valid dan dapat mereka ambil. Anggap terdapat 1000 sampel. Cukup? Anggap saja cukup.

Apabila kita memberikan 1000 sampel, berarti berdasarkan data, harus terdapat 900 orang yang merekomendasikan pasta gigi ini. Sekarang, ada sebuah pertanyaan mendasar. Benarkah, secara valid, terdapat 900 orang yang merekomendasikan pasta gigi ini? Saya meragukannya.

Saya rasa, angka yang valid adalah angka yang “tidak bulat”, dalam hal ini entah 9.5, 9.28, 9.18, dan seterusnya. Apakah itu berarti ada dokter gigi yang “terpotong”? Tidak juga. Seharusnya, data yang paling tepat dikatakan adalah “Pasta Gigi X direkomendasikan oleh 9 sampai 10 dari 10 dokter gigi”. Valid? Ya. Detail? Ya.

Lebih lanjut tentang permasalahan ini adalah bagaimana sebuah riset yang diberlakukan oleh sebuah tim peneliti. Faktanya yang diberikan oleh peneliti adalah, sebuah koin identik yang dilempar menghasilkan “Head” 80% sepanjang waktu.

Valid? Yah, awalnya kita kira valid, tapi setelah mengetahui bahwa ternyata hanya dilakukan percobaan sebanyak 10 kali, dan 8 diantaranya menghasilkan “Head”, tentu saja kita akan tertawa melihat hasil percobaan itu. 10 kali percobaan terlalu kecil untuk menghasilkan sebuah teori, namun apabila kita melakukan percobaan lempar koin sebanyak 10 kali, dapat dilihat bahwa peluang terjadinya kejadian tersebut adalah sebanyak 50%.
...
Tes IQ (atau berbagai macam tes yang lain), hanya dilakukan sekali. Pertanyaannya, apakah Tes IQ 100% akurat? Tidak mungkin, tentu saja terdapat error yang terjadi. Namun, kebanyakan orang tidak terlalu mempedulikan faktor error yang ada, dengan hanya memperhatikan hasil-hasil yang ada.
...
Mengesankan? Ya. Tapi jangan lupakan fakta berikut. Anggap fakta tersebut jujur. Tapi, apakah benar kuman tersebut memang hidup di tenggorokan? Apakah faktor-faktor dari laboratorium tidak menjadi acuan, seperti suhu dan kelembaban? Atau bahkan, itu bukan benar-benar kuman? 

Fakta lain, dinas kepolisian mengeluarkan sebuah fakta mengejutkan bahwa :
...
Tidak ada kesalahan pada statistiknya, tidak ada kesalahan pada data-data yang diberikan. Kesalahan yang mungkin terjadi adalah pada persepsi wanita yang membaca berita ini. Mungkin saja, karena membaca statistik ini, seorang wanita jadi tidak tertarik untuk masuk kuliah karena takut tidak mendapatkan pasangan. Faktanya, kedua hal ini (masuk universitas dan mendapatkan jodoh) tidak ada hubungannya, setidaknya pada fakta statistik diatas. Namun, fakta statistik tidak memberikan kesimpulan yang jelas, sehingga orang-orang memberikan persepsi yang berbeda untuk setiap kejadian.
